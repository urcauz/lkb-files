          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400 text-sm">
                Exclusive content for approved members
              </p>
            </div>
            ...
            <div className="space-y-3 py-6">
              <div className="flex items-center gap-3 text-left">
                ...
                <p className="text-sm text-gray-300">Premium exclusive content</p>
              </div>
              <div className="flex items-center gap-3 text-left">
                <Lock className="h-5 w-5 text-violet-400 flex-shrink-0" />
                <p className="text-sm text-gray-300">Secure Discord authentication</p>
              </div>
            </div>
            ...
            <p className="text-xs text-gray-500 pt-4">
              By logging in, you agree to request access which will be reviewed by the creator
            </p>
          </div>
        </div>
      </div>
